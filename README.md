...
Проект работает на [vinext](https://github.com/cloudflare/vinext) и собирается как OpenAI Site/Cloudflare Worker artifact.
...
- `npm test`: build, validate, verify rendered metadata, interaction contracts, modal semantics, 37/37 page contracts, and persisted setup dependencies
